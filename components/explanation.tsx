  ...
  return (
    <div className="flex flex-col gap-8 max-w-3xl">
      <p>
        ...
        zdania, które najlepiej opisują Twoje funkcjonowanie w grupie. Nie ma tu
        takich zdań, których mógłbyś się wstydzić lub obawiać . Nie ma tu zdań
        dobrych albo złych. Każde wybrane przez Ciebie zdanie jest równie dobre,
        jak każde inne, jeśli tylko zrobiłaś je szczerze, gdyż w badaniu tym
        chodzi o jak najlepsze poznanie Ciebie dla Twojego własnego dobra.
      </p>
      <p>
